using LahjatunaAPI.Dtos;
using LahjatunaAPI.Dtos.Auth;
...
namespace LahjatunaAPI.Controllers.Auth
{
    [ApiController]
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterDto registerDto)
        {
            using (var scope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
                ...
                try
                {
                    ...
                    await emailBackgroundService.QueueEmailAsync(user.Email!, "Confirm Your FurniFusion Email", template.Replace("{{confirmationLink}}", confirmationLink!));
        ...
        public async Task<IActionResult> SendResetPassword([FromBody] SendResetPasswordDto resetPassword)
        {
            ...
            try
            {
                ...
                // Queue the email sending as a background job
                var emailBackgroundService = HttpContext.RequestServices.GetRequiredService<EmailBackgroundService>();
                await emailBackgroundService.QueueEmailAsync(user.Email!, "Confirm Your FurniFusion Email", template.Replace("{{resetLink}}", resetLink!));
